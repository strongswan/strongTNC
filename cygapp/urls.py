...
urlpatterns = patterns('',
        ...
        url(r'^packages/check/None$', package_views.check, name='check'),
        url(r'^packages/check/\d+$', package_views.check, name='check'),
        ...
        url(r'^policies/check/None$', policy_views.check, name='check'),
        url(r'^policies/check/\d+$', policy_views.check, name='check'),
        ...
        url(r'^enforcements/(?P<enforcementID>\d+)/delete/?$', enforcement_views.delete,
            name='delete'),
        url(r'^enforcements/check/None$', enforcement_views.check, name='check'),
        url(r'^enforcements/check/\d+$', enforcement_views.check, name='check'),
